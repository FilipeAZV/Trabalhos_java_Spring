package br.com.lipeazv.aprendendospring.controllers;
...
import br.com.lipeazv.aprendendospring.repositories.PessoaRepository;
...
public class PessoaController {
	...
	public ResponseEntity<List<Pessoa>> ListPessoas() {
		...
		ResponseEntity<List<Pessoa>> resposta = new ResponseEntity<List<Pessoa>>(pessoas, new HttpHeaders(),
				HttpStatus.OK);
		return resposta;
	...
	public ResponseEntity<Pessoa> addPessoa(@RequestBody Pessoa pessoa) {
		...
		ResponseEntity<Pessoa> resposta = new ResponseEntity<Pessoa>(pessoaSalva, new HttpHeaders(),
				HttpStatus.CREATED);
		return resposta;
	...
	public ResponseEntity<Pessoa> updatePessoa(@RequestBody Pessoa pessoa) throws NotFoundException {
		if (pessoa.getId() == null) {
			...
			ResponseEntity<Pessoa> resposta = new ResponseEntity<Pessoa>(pessoaAlterada, new HttpHeaders(),
					HttpStatus.OK);
			return resposta;
		}
	}
